...
_SYSTEM = (
    ...
    "Favor: material company-specific catalysts; supplier/customer/competitor "
    "spillover where the affected NEIGHBOR hasn't moved yet; building multi-day "
    "themes; big catalysts whose initial move may CONTINUE for days. "
